...
let MemberController = class MemberController {
    ...
    create(request, projectId, createMemberDto) {
        return this.memberService.create(createMemberDto, projectId, request.systemInfo.userId);
    }
    findAll() {
        return this.memberService.findAll();
    }
    getAllMembersPerProject(projectId, search = '', pageSize = 10, pageNumber = 1, role = '') {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String, create_member_dto_1.CreateMemberDto]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], MemberController.prototype, "getAllMembersPerProject", null);
__decorate([
    (0, common_1.Get)(':id'),
